...
class PyInfoFrame(wx.Frame):
    ...
    def __init__(self, parent, message, title, icon):
        ...
        wx.Frame.__init__(self, parent, wx.ID_ANY, title, wx.DefaultPosition,
                          wx.DefaultSize, wx.NO_BORDER|wx.FRAME_TOOL_WINDOW|wx.FRAME_SHAPED|wx.FRAME_FLOAT_ON_PARENT)
    ...
    def OnPaint(self, event):
        ...
        endColour = wx.Colour(240,98,161)
        startColour = wx.Colour(255,135,198)
