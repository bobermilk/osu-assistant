...
class Sources(e.Sources):
    def __init__(self):
        ...
        self.user_source["User: played=top&fav status=r&gp&p&g Polyester"]=e.UserpageSource(["https://osu.ppy.sh/users/11106874/mania"],[True,True,False,True,False,True,True,True])
        self.user_source["User: status=r&l&gp&p&g -mint- riunosk"]=e.UserpageSource(["https://osu.ppy.sh/users/5594381", "https://osu.ppy.sh/users/8976576"],[False,False,False,True,True,True,True,True])
