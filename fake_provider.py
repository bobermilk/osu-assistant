...
class Sources(e.Sources):
    def __init__(self):
        super().__init__()
        # Create mock data
        self.user_source["User: played=all bobermilk"]=e.UserpageSource(["https://osu.ppy.sh/users/15656848"],[False,True,False,False,False,False,False])
        self.user_source["User: played=top&fav status=r&gp&p&g mode=m Polyester"]=e.UserpageSource(["https://osu.ppy.sh/users/11106874/mania"],[True,True,False,False,True,True,True])
        self.user_source["User: status=r&l&gp&p&g mode=m -mint- riunosk"]=e.UserpageSource(["https://osu.ppy.sh/users/5594381", "https://osu.ppy.sh/users/8976576"],[False,False,False,True,True,True,True])
        ...
        self.mappack_source["Mappack: mode=m #109 #108"]=e.MappackSource({109, 108})
