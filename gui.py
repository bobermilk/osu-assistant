...
class Main ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_notebook2.AddPage( self.m_panel_sources, u"Sources", True )
		...
		bSizer5.Add( self.m_activity_progress, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL|wx.TOP, 5 )
		...
		bSizer5.Add( self.m_progressbar, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.BOTTOM|wx.RIGHT|wx.LEFT|wx.EXPAND, 5 )
		...
		self.m_notebook2.AddPage( self.m_panel_help, u"Help", False )
